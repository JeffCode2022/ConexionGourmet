...
import razorpay
from conexionGour_main.settings import RZP_KEY_ID, RZP_KEY_SECRET
...
def place_order(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            order.save() # order id/ pk es generado
...
def payments(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest' and request.method == 'POST':
        # Guardar los detalles del pago en el modelo de pago
        ...
        # Actualizar el modelo de orden
        order.payment = payment
        order.is_ordered = True
        order.save()

        # Mover los artículos del carrito al modelo de alimentos ordenados
        ...
        for item in cart_items:
            ...
            ordered_food.amount = item.fooditem.price * item.quantity # cantidad total
            ordered_food.save()
        ...
        # Enviar correo de notificación de pedido recibido al vendedor
        ...
        # Devolver respuesta AJAX con el estado de éxito o fracaso
        response = {
